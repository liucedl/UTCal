...
<body>
	...
	<div class="text_l">
		<img src="../Img/sub_title.gif" width="10" height="14"
			align="absmiddle" style="margin-right: 5px">Add User
	</div>
	<div class="text">&nbsp;</div>
	<form name="usercheck" method="post" action="User_Add_Check">
						...
						<table cellpadding="4" cellspacing="1" border="0" width="539"
							...
							<tbody>
								<tr>
									...
									<td align="left"><input name="test_userid" value="${param.id}"
